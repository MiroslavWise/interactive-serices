...
export const SearchInput: TSearchInput = ({ placeholder, classNames, value, setValue }) => {
    return (
        <div className={cx(styles.container, classNames)} data-search>
            <img className={styles.image} src="/svg/search-lg.svg" alt="search" width={20} height={20} />
