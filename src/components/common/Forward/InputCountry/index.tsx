...
import { type DetailedHTMLProps, type DispatchWithoutAction, forwardRef, type InputHTMLAttributes } from "react"
...
const InputCountry = forwardRef(
  (props: DetailedHTMLProps<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> & { replaceValue: DispatchWithoutAction }) => {
    ...
    const current = FLAGS.find((_) => _.short === EnumCountry.ru)

    return (
      <div
        className="w-full h-12 relative z-40"
        // ref={refDiv}
      >
        <InputMask
          type="text"
