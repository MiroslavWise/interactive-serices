                ...
                if (!!type && step > 1) {
                    if (isVisible) {
                        ...
                        const scrollHandlerUL = () => {
                            ...
                            const topAddressUL =
                                idAddressUL?.getBoundingClientRect().top! < 20 ? 20 : idAddressUL?.getBoundingClientRect().top!
                            ...
                            const topPhotosUL =
                                idPhotosUL?.getBoundingClientRect().top! < 20 ? 20 : idPhotosUL?.getBoundingClientRect().top!
                            const topSubmitUL =
                                idSubmitUL?.getBoundingClientRect().top! < 20 ? 20 : idSubmitUL?.getBoundingClientRect().top!
