...
export const HasClustererBalloons = () => {
  ...
  return (
    <div
      className={cx(
        "wrapper-fixed",
        "bg-translucent flex flex-col items-start py-0 md:pr-10",
        visibleHasBalloon ? "!z-[209] !visible !opacity-100" : "-z-10 opacity-0 invisible",
      )}
    >
      <section
        data-section-modal
        className="relative md:max-w-[27.735rem] w-full h-full md:rounded-l-[2rem] flex flex-col max-md:justify-end max-md:p-0 max-md:pt-8 bg-BG-second"
      >
