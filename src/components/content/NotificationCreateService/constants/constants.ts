...
const DESCRIPTION = new Map([
  [1, "Мы знаем, что вы талантливы. Как насчет того, чтобы разместить свое умение и услугу на карте? Попробуйте!"],
