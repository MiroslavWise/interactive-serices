...
export function Barter() {
  const { isVisible, setIsVisibleBarter, dataProfile } = useVisibleModalBarter()

  if (isMobile) {
    return (
      <div className={cx(styles.wrapperContainerMobile, isVisible && styles.visible)}>
        <header>
          <div className={styles.buttonBack} onClick={() => setIsVisibleBarter({ isVisible: false })}>
            <Image
