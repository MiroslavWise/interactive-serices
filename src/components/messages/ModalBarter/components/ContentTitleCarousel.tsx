...
import { CustomDatePicker, CustomInputText, CustomSelect } from "@/components/common/custom"
    ...
    <section className={styles.containerTitleCarousel}>
      ...
      <div className={styles.button}>
        <ButtonFill
          ...
          suffix={<Image src="/svg/arrow-right.svg" alt="arrow-right" width={24} height={24} />}
        />
      </div>
    </section>
  )
