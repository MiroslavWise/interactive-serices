export default () => (
  <div className="loading-screen w-full h-full bg-BG-second p-5 flex flex-col justify-between rounded-2">
    <section className="w-full flex flex-col items-center gap-5">
      ...
      <div className="w-full flex flex-col gap-2.5">
        ...
        <article className="w-full rounded-.625 p-4 border border-solid border-grey-stroke-light grid grid-cols-[minmax(0,1fr)_3.125rem] gap-2.5 *:h-5 *:w-full *:rounded-xl">
          <span />
          <span />
        </article>
      </div>
