...
function Wrapper({ children }: { children: ReactNode }) {
  ...
  return (
    <aside
      className={cx(
        "w-full h-full md:rounded-[2rem] overflow-hidden bg-BG-second flex flex-col justify-start md:pt-5 md:px-5 md:max-h-[calc(100vh_-_var(--height-header-nav-bar)_-_1.5rem_-_1.5rem)]",
