  ...
  <>
    <main
      className={cx(
        ...
        "md:overflow-hidden md:pt-[calc(var(--height-header-nav-bar)_+_1.5rem)] md:pb-5 md:px-6 z-[4] relative md:static md:grid md:grid-cols-[17.125rem_minmax(0,1fr)_25rem] md:gap-6",
