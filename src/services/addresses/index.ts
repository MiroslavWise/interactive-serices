...
import type { IResponseAddresses, IAddressesResponse, IPostAddress, IPatchAddress } from "./types/serviceAddresses"
...
export const serviceAddresses: IResponseAddresses = {
    ...
    postAddress(value) {
        return wrapperFetch.methodPost<IPostAddress, IAddressesResponse>(this.route, value)
    },
    patchAddress(value, id) {
        return wrapperFetch.methodPatch<IPatchAddress, IAddressesResponse>(this.route, value, id)
    },
    deleteAddress(id) {
