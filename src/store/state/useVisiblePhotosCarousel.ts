...
export const setPrevPhotoCarousel = () =>
    useVisiblePhotosCarousel.setState((state) => {
        ...
        return currentIndex === 0 ? { currentPhoto: photos[length - 1] } : { currentPhoto: photos[currentIndex - 1] }
    })
...
export const setNextPhotoCarousel = () =>
    useVisiblePhotosCarousel.setState((state) => {
        ...
        return currentIndex === length - 1 ? { currentPhoto: photos[0] } : { currentPhoto: photos[currentIndex + 1] }
    })
